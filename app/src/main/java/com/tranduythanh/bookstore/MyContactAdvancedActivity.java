...
import com.tranduythanh.adapter.MyContactAdapter;
...
//    ArrayAdapter<String> contactAdapter;
    ...
    private void loadContacts() {
        ...
        {
            int nameIndex =cursor.getColumnIndex(ContactsContract.Contacts.DISPLAY_NAME); // lấy vị vị trí tên KH truớc mới suy ra được thứ khác
            String name = cursor.getString(nameIndex); //Get Name
            int phoneIndex =cursor.getColumnIndex(ContactsContract.CommonDataKinds. Phone.NUMBER);
            String phone = cursor.getString(phoneIndex); //Get Phone Number000
    ...
    private void addViews() {
        edtContactName=findViewById(R.id.edtConctactName);
...
//        contactAdapter=new ArrayAdapter<>(this, android.R.layout.simple_list_item_1);
    ...
    public void makeDirectCal(MyContact contact){
